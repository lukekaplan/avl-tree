...
private:
    ...
    string pathToHelper(AVLNode* node, const string& x) const;

    bool findHelper(AVLNode* node, const string& x) const;

    int numNodesHelper(AVLNode* node) const;

    void insertHelper(AVLNode*& node, const string &x);

    int balanceFactor(AVLNode* node) const;

    void updateHeight(AVLNode* n) const;

    void updateBalanceFactor(AVLNode* node) const;

    void checkBalance(AVLNode*& n);
